...
3. In BlueStacks, open a browser and navigate to the URL shown (e.g., `http://192.168.1.100:8000/BensSportsBookApp.html`)
...
3. **Access from BlueStacks:**
   ...
   - Navigate to: `http://YOUR_PC_IP:8000/BensSportsBookApp.html`
   - Replace `YOUR_PC_IP` with your PC's local IP (e.g., `http://192.168.1.100:8000/BensSportsBookApp.html`)

## What to Test

### ✅ Mobile Detection & Redirect
- Visiting the main page (`BensSportsBookApp.html`) should automatically redirect to the mobile version (`ArbritrageBetFinder-mobile.html`)
...
5. Navigate to `http://YOUR_PC_IP:8000/BensSportsBookApp.html`
...
- **Desktop version:** `frontend/BensSportsBookApp.html`
