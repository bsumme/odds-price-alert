...
Write-Host "  Desktop: http://127.0.0.1:8000/ArbritrageBetFinder.html" -ForegroundColor Cyan
Write-Host "  Mobile:  http://$ipAddress:8000/ArbritrageBetFinder.html" -ForegroundColor Cyan
Write-Host ""
Write-Host "In BlueStacks, open a browser and navigate to:" -ForegroundColor Yellow
Write-Host "  http://$ipAddress:8000/ArbritrageBetFinder.html" -ForegroundColor White
Write-Host ""
